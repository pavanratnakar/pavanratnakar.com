...
class Functions
{
	...
	{
		if($_SESSION['uid'] && !isset($_COOKIE['pavanRemember']) && !$_SESSION['rememberMe'])
		{
			// If you are logged in, but you don't have the pavanSite cookie (browser restart)
	...
	public function facebookcurPageURL() 
	{
		//$pageURL = 'http';
		//if ($_SERVER["HTTPS"] == "on") {$pageURL .= "s";}
			//$pageURL .= "://";
	...
	public function tutorialLike($typeKeyword,$subject)
	{
		echo '<div class="left"><fb:like href="http://www.pavanratnakar.com/tutorial/'.$typeKeyword.'/'.$subject.'" send="true" layout="button_count" width="400" show_faces="true" colorscheme="dark" font="lucida grande"></fb:like></div>';
		echo '<div class="right"><a onClick="javascript: _gaq.push(["_trackPageview", "/download/'.$subject.'.rar"]);" class="bt_login" href="/download/'.$subject.'.rar">Download Tutorial</a></div>';
	}
}
?>