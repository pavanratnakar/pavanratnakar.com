...
$page=new Page();
$pageDetails=$page->pageDetails('../../../xml/page.xml');
...
$pdf->SetAuthor('Pavan Ratnakar');
$pdf->SetTitle($pageDetails[$pageNumber]['title']);
$pdf->SetSubject($pageDetails[$pageNumber]['description']);
$pdf->SetKeywords($pageDetails[$pageNumber]['keywords']);
...
//set margins
$pdf->SetMargins(PDF_MARGIN_LEFT, 6, PDF_MARGIN_RIGHT, 0);
...
$html = file_get_contents("../../../include/resumeBody.php");
...
$pdf->Output('Pavan_Ratnakar_Resume.pdf', 'I');
//============================================================+
// END OF FILE                                                
//============================================================+